        ...
        >
          {LINKS_DATA.map((link) => (
            <motion.a
              ...
              className="group relative flex flex-col squircle apple-border-inset apple-shadow-sm bg-foreground/2 backdrop-blur-md border border-foreground/10 hover:border-terracotta/40 hover:-translate-y-1 transition-all duration-300 ease-out"
              style={{ padding: '2rem' }}
            >
